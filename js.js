...
const Cards = [[1,
 ...
 source:"./img/3.jpg",
  ...
  {
    id:4,      source:"./img/4.jpg",
  }],[5,
  
  {
    id:5,      source:"./img/5.jpg",
  }], [6,
  
  {
    id:6,      source:"./img/6.jpg",
  }  ]
]
...
class Game{  
  constructor(onEndGame, elCanvas) {
    ...
    this.numTuplesOK = 0
    this.numClicks = 0
    this.resultArray = ["ʘ‿ʘ Excelente!", "(´･_･`) No esta mal", "¯\\_(ツ)_/¯ Intenta de nuevo "]
